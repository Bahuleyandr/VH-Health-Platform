...
const adminQuickLinks = [
  ...
  { label: "Leave Approvals", href: "/dashboard/leave-approvals", icon: CalendarCheck },
  { label: "Attendance Audit", href: "/dashboard/attendance-audit", icon: Activity },
          ...
          {adminQuickLinks.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className="flex items-center gap-3 rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-white transition-colors hover:border-indigo-500/60 hover:bg-muted/50"
              >

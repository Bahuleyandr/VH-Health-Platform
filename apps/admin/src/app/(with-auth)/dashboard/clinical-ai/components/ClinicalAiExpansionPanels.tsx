...
const PANELS: PanelComponent[] = [
  ...
  deferredPanel(() => import("./coreModulePanels/TierAAssistantsPanel")),
  deferredPanel(() => import("./coreModulePanels/SurgicalAiPanel")),
  deferredPanel(() => import("./coreModulePanels/TierCAssistantsPanel")),
  deferredPanel(() => import("./coreModulePanels/TierDEmergencyPanel")),
  deferredPanel(() => import("./coreModulePanels/TierEPatientEngagementPanel")),
  deferredPanel(() => import("./coreModulePanels/TierFInteropPanel")),
  deferredPanel(() => import("./coreModulePanels/TierGPublicHealthPanel")),
  deferredPanel(() => import("./coreModulePanels/TierHOperationalPanel")),

...
export function FnFSection({ staff }: { staff: StaffForPayroll[] }) {
  ...
  const statusChip = (s: string) => {
    ...
    return (
      <span
        className={`text-xs px-2 py-0.5 rounded-full font-medium ${map[s] ?? "bg-gray-100 text-gray-600"}`}
      >
        {s}
      </span>
    );
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            <div>
              ...
              <select
                ...
                value={form.staff_uid}
                onChange={(e) =>
                  setForm((f) => ({ ...f, staff_uid: e.target.value }))
                }
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, separation_type: e.target.value }))
                }
              >
                {[
                  "resignation",
            ...
            <div>
              ...
              <input
                type="number"
                className="w-full mt-1 border rounded px-2 py-1.5 text-sm"
                value={form.notice_shortfall_days}
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    notice_shortfall_days: +e.target.value,
                  }))
                }
              />
            </div>
            <div>
              ...
              <input
                type="number"
                className="w-full mt-1 border rounded px-2 py-1.5 text-sm"
                value={form.bonus_payable}
                onChange={(e) =>
                  setForm((f) => ({ ...f, bonus_payable: +e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, other_deductions: +e.target.value }))
                }
              />
            </div>
          </div>

...
/** Download a CSV document that was generated by a server-side export. */
export function exportCsvText(filename: string, csv: string): void {
  if (typeof window === "undefined") {
    throw new Error("exportCsvText must be called in the browser");
  }

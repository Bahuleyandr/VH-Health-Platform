...
export const operations = {
  ...
  'GET /api/v1/documents/import/reconciliation': {
    ...
    additionalResponses: {
      ...
      429: errorResponse('The caller exceeded an API rate limit, or another worklist scan is already open for the same tenant; both responses include Retry-After: 1.'),

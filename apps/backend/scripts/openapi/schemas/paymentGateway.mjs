  ...
  PaymentGatewayRefundReconcileRequest: {
    ...
    properties: {
      disposition: {
        type: 'string',
        enum: ['provider_processed', 'provider_failed', 'provider_pending', 'provider_status_unknown'],
        description: 'Structured review outcome. provider_processed, provider_pending, and provider_status_unknown remain open and pollable. provider_failed is terminal only when an exact validated provider refund id is already bound; otherwise it remains open and replacement-blocking. Processed and failed observations require an independent reviewer.',
      },
      evidence: {
        type: 'object',
        additionalProperties: false,
...
export const operations = {
  ...
  'POST /api/v1/billing/gateway/refunds/{id}/reconcile': {
    ...
    additionalResponses: {
      400: errorResponse('The disposition or structured evidence was missing, invalid, future-dated, or internally inconsistent.'),
      401: errorResponse('API-key and bearer authentication are required.'),

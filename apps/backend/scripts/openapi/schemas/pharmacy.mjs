...
export const schemas = {
  ...
  PharmacyOrderLine: {
    ...
    properties: {
      ...
      qty: { type: 'number', exclusiveMinimum: 0, nullable: true },
      ordered_qty: { type: 'number', exclusiveMinimum: 0, nullable: true },
      prescribed_qty: { type: 'number', exclusiveMinimum: 0, nullable: true },
    ...
    properties: {
      ...
      patient: {
        ...
        properties: {
          ...
          weight_kg: { type: 'number', exclusiveMinimum: 0, nullable: true },
  ...
  PharmacyCounterDispenseLine: {
    ...
    properties: {
      ...
      medication_name: { type: 'string', minLength: 1 },
      drug_name: { type: 'string', minLength: 1 },
      dispensed_quantity: { type: 'number', exclusiveMinimum: 0 },
      dispensed_qty: { type: 'number', exclusiveMinimum: 0 },
      qty: { type: 'number', exclusiveMinimum: 0 },
      quantity: { type: 'number', exclusiveMinimum: 0 },
      dispensed_quantity_ml: { type: 'number', exclusiveMinimum: 0 },
  ...
  PharmacyOrderDispensedLine: {
    ...
    properties: {
      ...
      catalog_id: { type: 'integer', minimum: 1 },
      inventory_item_id: { type: 'integer', minimum: 1 },
      ordered_qty: { type: 'number', exclusiveMinimum: 0 },
  ...
  PharmacyOrderDispenseRecoveryDetails: {
    ...
    properties: {
      ...
      inventory_item_id: { type: 'integer', minimum: 1 },
      inventory_batch_id: { type: 'integer', minimum: 1 },
      required_quantity: { type: 'number', exclusiveMinimum: 0 },
      payment_mode: { type: 'string', enum: PHARMACY_PAYMENT_MODES, nullable: true },
      payment_status: { type: 'string', nullable: true },
      amount_collected: { ...nonNegativeMoney, nullable: true },
      total_amount: { ...nonNegativeMoney, nullable: true },
  ...
  PharmacySupplyStockMovementRequest: {
    ...
    properties: {
      ...
      quantity_delta: { type: 'number', exclusiveMinimum: 0 },

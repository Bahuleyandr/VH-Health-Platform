...
export const APPOINTMENT_CONFIG = {
  ...
  PERMISSIONS: {
    VIEW_ALL: ['ADMIN', 'SUPER_ADMIN', 'DOCTOR', 'NURSING_STAFF', 'RECEPTIONIST', 'RECEPTION_INCHARGE'],
    VIEW_TODAY: ['ADMIN', 'SUPER_ADMIN', 'DOCTOR', 'NURSING_STAFF', 'RECEPTIONIST', 'RECEPTION_INCHARGE'],
    BOOK: ['ADMIN', 'SUPER_ADMIN', 'DOCTOR', 'NURSING_STAFF', 'RECEPTIONIST', 'RECEPTION_INCHARGE', 'PATIENT'],
    UPDATE: ['ADMIN', 'SUPER_ADMIN', 'DOCTOR', 'NURSING_STAFF', 'RECEPTIONIST', 'RECEPTION_INCHARGE', 'PATIENT'],
    CANCEL: ['ADMIN', 'SUPER_ADMIN', 'DOCTOR', 'RECEPTIONIST', 'RECEPTION_INCHARGE', 'PATIENT']
  },

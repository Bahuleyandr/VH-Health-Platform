...
const entry = (id, name, disposition, extra = {}) => Object.freeze({
  ...
  name,
  disposition,
  implemented: ['I01', 'I02', 'I04', 'I05', 'I06', 'I09', 'I10', 'I13', 'I15', 'I16', 'I17', 'I18', 'I19', 'I23'].includes(id),
...
const catalogEntries = [
  ...
  entry('I06', 'PACS and DICOM', MIXED, {
    ...
    cursorKind: 'monotonic_position_and_predecessor',
    facilityScope: 'tenant',
    duplicateKeyKind: 'tenant_order_study_uid_payload_sha256',
    partitionKind: 'tenant_radiology_order_study_link',
  }),
  ...
  entry('I23', 'ClinicalTrials.gov catalog', HWM, {
    ...
    providerRevision: 'clinicaltrials_gov_data_timestamp_and_study_last_update_posted',

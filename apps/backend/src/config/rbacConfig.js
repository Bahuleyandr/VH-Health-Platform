...
export default {
  ...
  recordRoutes: [ADMIN, GENERAL_STAFF, DOCTOR, NURSING_STAFF, IP_STAFF_NURSE, OP_STAFF_NURSE, OT_NURSE, CATH_LAB_STAFF],
  // ✅ Fix: use NURSING_STAFF constant instead of string 'NURSE'
  healthRecordsRoutes: [PATIENT, ADMIN, DOCTOR, NURSING_STAFF, IP_STAFF_NURSE, OP_STAFF_NURSE, OT_NURSE, CATH_LAB_STAFF],

...
const UI_FEATURES_BY_ROLE = {
  ...
  OP_STAFF_NURSE: ['front_office_workbench', 'op_nursing_dashboard', 'appointments', 'dental_charting', 'patient_records', 'lab_bookings', 'nursing_notes'],
  OP_INCHARGE: ['front_office_workbench', 'op_nursing_dashboard', 'appointments', 'dental_charting', 'patient_records', 'lab_bookings', 'nursing_notes', 'op_nursing_roster'],

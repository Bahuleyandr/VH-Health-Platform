import { getStaffRosterRoleCodes } from './rolePolicyGraph.js';
...
export const STAFF_ROLES = Object.fromEntries(
  getStaffRosterRoleCodes().map((roleCode) => [roleCode, roleCode])
);

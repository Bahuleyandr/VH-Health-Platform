...
import clinicalAlertDeliveryRecoveryRoutes from './clinicalAlertDeliveryRecoveryRoutes.js';
...
router.use('/clinical-alert-delivery', clinicalAlertDeliveryRecoveryRoutes);

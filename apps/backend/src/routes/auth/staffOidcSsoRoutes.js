...
import * as controller from '../../controllers/auth/staffOidcSsoController.js';
...
router.post('/:provider/callback', authRateLimiter, providerParam, handleValidation, controller.callback);

...
describe('canonical timeline coverage guard', () => {
  const requiredCanonicalWriters = [
    ...
    ['services/investigation/investigationService.js', ['recordCanonicalClinicalEvent', 'investigation.status_changed', 'investigation.result_ready', 'investigation.result_critical']],

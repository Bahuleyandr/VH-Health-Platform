...
class BedBoardPrintService {
  ...
  static Future<void> print({
    ...
    String generatedBy = 'Generated by VHHealth Staff app',
  }) async {
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (ctx) => _buildFooter(ctx, generatedBy),
        build: (ctx) => [
  ...
  static pw.Widget _buildFooter(pw.Context ctx, String generatedBy) {
    return pw.Padding(

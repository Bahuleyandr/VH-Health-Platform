    ...
    if (_incidents.isEmpty) {
      return Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('No incident reports', style: TextStyle(color: Colors.grey.shade600)),
        ]),
      );
    }
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (ctx, i) {
          ...
          final type = (inc['incident_type'] as String? ?? '').replaceAll('_', ' ');
            ...
            child: ListTile(
              leading: Container(
                ...
                child: Icon(Icons.warning_amber_rounded,
                    color: _severityColor(severity), size: 22),
              ),
              title: Text(
                inc['title'] as String? ?? '',
                maxLines: 1,
              ...
              subtitle: Column(
                ...
                children: [
                  Text(inc['report_number'] as String? ?? '',
              ...
              trailing: Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      fontSize: 9, color: _statusColor(status), fontWeight: FontWeight.bold),
                ),
              ),
        ...
        builder: (_, ctrl) => Padding(
          ...
          child: ListView(controller: ctrl, children: [
            Text(
              ...
              style: const TextStyle(
                  fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF007A64)),
            ),
            ...
            _detailRow('Status',
                (inc['status'] as String? ?? '').replaceAll('_', ' ').toUpperCase()),
            _detailRow('Severity', (inc['severity'] as String? ?? '').toUpperCase()),
            _detailRow('Type',
                (inc['incident_type'] as String? ?? '').replaceAll('_', ' ')),
            if (inc['location'] != null) _detailRow('Location', inc['location'] as String),
            const Divider(),
    ...
    if (_grievances.isEmpty) {
      return Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const SizedBox(height: 8),
          Text('No grievances filed', style: TextStyle(color: Colors.grey.shade600)),
        ]),
      );
    }
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (ctx, i) {
          ...
          final type = (grv['grievance_type'] as String? ?? '').replaceAll('_', ' ');
          ...
          return Card(
            child: ListTile(
              leading: Container(
                ...
                child:
                    const Icon(Icons.support_agent_outlined, color: Colors.purple, size: 22),
              ),
              title: Text(
              ...
              subtitle: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(grv['grievance_number'] as String? ?? '',
                      style: const TextStyle(
                          fontSize: 11,

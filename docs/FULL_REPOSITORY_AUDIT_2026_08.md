...
| `maternity_deliveries` | `delivery_mode` | When newly added, the named CHECK is `NOT VALID` and enforces new writes; an existing same-name CHECK's validation state is preserved. |

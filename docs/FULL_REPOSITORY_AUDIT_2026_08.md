...
| HELD-12 | **Human linguistic approval.** The five-locale technical contract is `en`/`hi`/`ta`/`te`/`ml`; #965 closes the known ABDM Malayalam omission. Technical key parity and placeholder wording are not approval of clinical, dosage, consent, legal, or ABDM meaning. | Locale resources, structural parity gates, and `docs/TRANSLATION_REVIEW_TRACKER.md`. | Named human linguistic reviewers, with clinical/legal review where the string carries those meanings. |

...
| Program | Wave | Status |
|---|---|---|
| NL-1 Enterprise identity | A | ◐ P4 SAML in review (P1 #436, P2 #439, P3 #444, [spec](superpowers/specs/2026-07-05-nl1-enterprise-identity-design.md)); admin/staff SSO held/default-off; staff JIT off, SCIM is the provisioning path |

...
| WS3 | 5 | 3 | B3.1 deterministic journey gate — harness + 5 core journeys (43 tests, blocking CI, swarm replacement) ✅ · B3.4 FHIR conformance + SAST (Semgrep/CodeQL) flipped BLOCKING ✅ · B3.5 cosign verify + ci.yml consolidation (SBOM/sign pre-existed) ✅ · B3.1b: 6 journeys remain (dynamic-acute-abdomen, obstetric-anc, pediatric-opd, surgical-day-care, tpa-insurance-claim) · next: B3.2 coverage floors, B3.3 Flutter clinical tests |
| WS4 | 6 | 3 | B4.4 Orthanc PACS hardened + OHIF viewer + ArgoCD app + runbook ✅ · B4.5 problem-list snapshots + terminology import/audit tables (mig 306/307, schema regen, drift clean) ✅ · B4.6 audit hash-chain already-built (mig 282 trigger + verifyAuditChain) + 13-case tamper unit test ✅ · next: B4.1 drug KB [flagged license], B4.2 BCMA closed loop, B4.3 med reconciliation |

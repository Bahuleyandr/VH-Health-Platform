...
| WS3 | 5 | 4 | B3.1 deterministic journey gate — harness + 5 core journeys (43 tests, blocking CI) ✅ · B3.3 Flutter clinical widget tests (132 tests: MAR/CDS/dispensing/walk-in, mirror-class pattern) ✅ · B3.4 FHIR conformance + SAST (Semgrep/CodeQL) flipped BLOCKING ✅ · B3.5 cosign verify + ci.yml consolidation ✅ · B3.1b: 6 journeys remain (dynamic-acute-abdomen, obstetric-anc, pediatric-opd, surgical-day-care, tpa-insurance-claim, +1) · next: B3.2 coverage floors |

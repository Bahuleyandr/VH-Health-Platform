...
- **Your reserved migration numbers: 489–494** (use in order; leave unused ones untaken; group the seven tables per the spec's "four to six migrations" estimate). Sibling Wave E blocks — P2 stroke 503–507, P4 nuclear-med 508–512, P6 transplant 546–554. Do NOT poach numbers outside 489–494.

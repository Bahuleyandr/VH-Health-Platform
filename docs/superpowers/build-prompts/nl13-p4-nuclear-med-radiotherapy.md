...
- **Your reserved migration numbers: 508–512** (use in order; leave unused ones untaken; group the six tables per the spec's "three to five migrations" estimate). Sibling Wave E blocks — P3 oncology 489–494 (you sequence AFTER P3), P2 stroke 503–507, P6 transplant 546–554. Do NOT poach numbers outside 508–512.

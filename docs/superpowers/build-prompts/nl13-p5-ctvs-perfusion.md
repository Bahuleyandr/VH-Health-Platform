...
3. **`perfusion_signoffs`** (mig **543**) per spec:242 — perfusionist sign-off, surgeon review, anesthesia review, canonical event; sign-off gates enforce the required reviews before finalize.

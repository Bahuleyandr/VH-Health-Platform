...
- The Health Points screen is the live patient surface for the points summary, tier progress, milestones, and reward claims (`apps/patient/lib/features/gamification/screens/health_points_screen.dart`).

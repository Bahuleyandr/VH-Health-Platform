...
// Alternative simpler version without blur effects if performance is an issue
class SimpleFeatureScreenScaffold extends StatelessWidget {
  final String title;
  final IconData icon;
  final Color color;
  final Widget child;
  ...
  const SimpleFeatureScreenScaffold({
    super.key,
    required this.title,
    required this.icon,
    required this.color,

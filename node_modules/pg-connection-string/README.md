...
var config = parse('postgresql://<user>:<password>@somehost:381/somedatabase')
```
...
const config: ClientConfig = parseIntoClientConfig('postgresql://<user>:<password>@somehost:381/somedatabase')
```
...
const config = parse('postgresql://<user>:<password>@somehost:381/somedatabase')

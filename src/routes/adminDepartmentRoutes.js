// src/routes/adminDepartmentRoutes.js - PRODUCTION VERSION
...
router.get('/overview', async (req, res) => {
  try {
    ...
    console.log('Database error for department overview:', error.message);
    res.status(500).json({
...
router.get('/manage', async (req, res) => {
  try {
    ...
    console.log('Database error for department management:', error.message);
    res.status(500).json({
...
router.get('/:id/financial', async (req, res) => {
  try {
    ...
    console.log('Database error for department financial data:', error.message);
    res.status(500).json({
...
router.get('/:id/staff-allocation', async (req, res) => {
  try {
    const { id } = req.params;
    ...
    console.log('Database error for staff allocation:', error.message);
    res.status(500).json({

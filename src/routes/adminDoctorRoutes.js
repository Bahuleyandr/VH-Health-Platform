// src/routes/adminDoctorRoutes.js - PRODUCTION VERSION
...
router.get('/overview', async (req, res) => {
  try {
    ...
    console.log('Database error for doctor overview:', error.message);
    res.status(500).json({
...
router.get('/manage', async (req, res) => {
  try {
    ...
    console.log('Database error for doctor management:', error.message);
    res.status(500).json({
...
router.get('/:id/analytics', async (req, res) => {
  try {
    ...
    console.log('Database error for doctor analytics:', error.message);
    res.status(500).json({
...
router.get('/workload-analysis', async (req, res) => {
  try {
    ...
    console.log('Database error for workload analysis:', error.message);
    res.status(500).json({
...
// Delete doctor account (admin only - soft delete)

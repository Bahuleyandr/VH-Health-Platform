// src/routes/adminNotificationRoutes.js - PRODUCTION VERSION
...
router.get('/overview', async (req, res) => {
  try {
    ...
    console.log('Database error for notification overview:', error.message);
    res.status(500).json({
...
router.get('/manage', async (req, res) => {
  try {
    ...
    console.log('Database error for notification management:', error.message);
    res.status(500).json({
...
router.post('/bulk-operations', async (req, res) => {
  try {
    ...
    console.log('Database error for bulk operations:', error.message);
    res.status(500).json({
...
router.get('/templates', async (req, res) => {
  try {
    ...
    console.log('Database error for templates:', error.message);
    res.json({
...
router.get('/delivery-stats', async (req, res) => {
  try {
    ...
    console.log('Database error for delivery stats:', error.message);
...
router.delete('/cleanup', async (req, res) => {
  try {
    ...
    console.log('Database error for cleanup:', error.message);
    res.status(500).json({
